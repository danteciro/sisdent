...
CREATE TABLE IF NOT EXISTS `agenda` (
  ...
  `faltou_agen` enum('Sim','Nao') default NULL,
...
CREATE TABLE IF NOT EXISTS `funcionarios` (
  ...
  `dtnasc_fun` varchar(10) NOT NULL,
  `sexo_fun` enum('Masculino','Feminino') NOT NULL,
  `foto_fun` blob,
  `endereco_fun` varchar(60) default NULL,
  ...
  `celular_fun` varchar(14) default NULL,
...
CREATE TABLE IF NOT EXISTS `pacientes` (
  ...
  `numero_pac` varchar(20) default NULL,
  ...
  `nome_con` varchar(60) default NULL,
...
INSERT INTO `tratamentos` (`cod_tratamento`, `nome_tra`, `descricao_tra`, `valor_tra`) VALUES
(1, 'Gengivite Terapêutica Básica', '', '40.00'),
(2, 'Controle de Placa Bacteriana', '', '20.00'),
(3, 'Aplicação Tópica de Flúor', '', '30.00');
